...
<body>
	...
	<table class="table table-striped" style="margin: auto; width: 80%;">
		...
		<tbody>
			...
			<tr>
			<td><input type="checkbox" class="chkCheckBoxId" name="delete" value="${y.getCid()}"></td>
			<td>${y.getName()}</td>
			<td>${y.getDescription()}</td>
			<th><a href="ViewOneCategory/${y.getCid()}" class="btn btn-primary">View</a></th>
			<th><a href="UpdateOneCategory/${y.getCid()}" class="btn btn-success">Update</a></th>
			</tr>
			</c:forEach>
		</tbody>
